...
RSpec.describe Championships::CollectionQuery do
  describe '.call' do
    ...
    context 'with includes - simple includes' do
    ...
    context 'with includes - nested includes' do
    ...
    context 'with includes - multiple includes' do
    ...
    context 'with includes - empty includes array' do
      let(:params) { { includes: [] } }
    ...
    context 'with pagination - page and per_page' do
    ...
    context 'with pagination - page but no per_page' do
      let(:params) { { page: 1 } }
    ...
    context 'with pagination - per_page but no page' do
