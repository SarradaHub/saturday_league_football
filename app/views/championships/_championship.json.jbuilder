...
json.rounds do
  json.array! championship.rounds.order(round_date: :asc), partial: 'rounds/round_list', as: :round
end

json.players do
  json.array! championship.players.distinct, partial: 'players/player_list', as: :player
end
